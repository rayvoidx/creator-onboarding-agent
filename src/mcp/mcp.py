...
class YouTubeMCP:
    ...
    def get_channel_overview(
        ...
        resolved_channel = self.resolve_channel_id(channel_id, channel_username, channel_handle)
    ...
    def get_video_details_by_ids(self, video_ids: List[str]) -> Dict[str, Dict[str, Any]]:
