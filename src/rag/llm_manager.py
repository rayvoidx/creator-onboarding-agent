...
class LLMManager:
    ...
    def route_request(
        ...
        if task_type == "coding":
            ...
            routing_config["model_name"] = self.engine.deep_model # Often coincides with smart models
            return routing_config
        ...
        logger.info(f"Routed request: Tier={user_tier}, Task={task_type}, Complexity={complexity} -> Model={routing_config['model_name']}")
        return routing_config
