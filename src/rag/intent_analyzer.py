    ...
    async def analyze_intent(
        ...
        try:
            ...
            try:
                ...
                if intent_str == "competency":
                    intent_str = "competency_assessment"
                if intent_str == "mission":
                    intent_str = "mission_matching"
            ...
            return {"intent": "general_chat", "confidence": 0.0, "error": str(e)}
