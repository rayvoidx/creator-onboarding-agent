...
class IntegrationAgent(BaseAgent):
    ...
    async def execute(self, state: IntegrationState) -> IntegrationState:
        ...
        try:
            ...
            integration_type = state.integration_type or state.context.get('integration_type', 'default')
    ...
    async def _process_webhook_integration(self, state: IntegrationState) -> Dict[str, Any]:
        """Webhook 통합 처리"""
        return {
            'type': 'webhook',
            'status': 'completed',
    ...
    async def _process_batch_integration(self, state: IntegrationState) -> Dict[str, Any]:
        """배치 통합 처리"""
        return {
            'type': 'batch',
            'status': 'completed',
    ...
    async def _process_default_integration(self, state: IntegrationState) -> Dict[str, Any]:
        """기본 통합 처리"""
        return {
            'type': 'default',
            'status': 'completed',
